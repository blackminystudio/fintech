...
class _ExpandableSearchFieldState extends State<ExpandableSearchField> {
  ...
  Widget build(BuildContext context) {
    ...
    final itemHeight = theme.sizing.s14;
  ...
  List<Widget> _buildExpandedWidgetLIst(
    ...
    Divider(height: theme.sizing.quarter, color: theme.colors.neutralBorder),
    ClipRRect(
      child: Material(
          ...
          child:
              itemCount > 0
                  ? ListView.builder(
                    ...
                    itemBuilder:
                        (context, index) =>
                            _buildListTile(itemHeight, index, theme, context),
                  )
