...
void main() {
  group('AuthStore', () {
    ...
    group('Initial State & Stream Listening', () {
      ...
      test('Given AuthStore is created '
          'When auth stream emits a valid user '
          'Then state should be authenticated with the user data', () async {
      ...
      test('Given AuthStore is created '
          ...
          'Then state should be unauthenticated with exception set', () async {
        const error = AppException(source: testPlugin, message: testMessage);
    ...
    group('Sign In', () {
      test('Given user signs in with Google '
          'When successful '
          'Then state becomes authenticated', () async {
      ...
      test('Given user signs in with Google '
          'When failure occurs '
          'Then state becomes unauthenticated with exception', () async {
        const error = AppException(message: testMessage, source: testPlugin);
    ...
    group('Logout', () {
      test('Given user is logged in '
          'When logout is called '
          'Then state becomes unauthenticated and logout is called', () async {
