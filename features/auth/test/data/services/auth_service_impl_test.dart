...
void main() {
  ...
  group('signInWithGoogle()', () {
    test('Given Google sign-in is cancelled '
        'When signInWithGoogle() is called '
        'Then throws AppException with signinCancelled type', () async {
      // Given
    ...
    test('Given valid Google sign-in and Firebase success '
        'When signInWithGoogle() is called '
        'Then returns a signed-in user', () async {
      // Given
      final user = MockUser(
        uid: testUid,
        email: testEmail,
  ...
  group('getCurrentUser()', () {
    test('Given no user is signed in '
    ...
    test('Given a user is signed in '
        'When getCurrentUser() is called '
  ...
  group('logout()', () {
    test('Given a user is signed in '
        ...
        'Then signs out from both Firebase and Google', () async {
      // Given
  ...
  group('authStateChanges()', () {
    test('Given a signed-in user '
        'When authStateChanges() is listened '
        'Then emits the user as the first event', () async {
      // Given
      final user = MockUser(email: testEmail);
      createService(user: user, signedIn: true);
    ...
    test('Given no signed-in user '
        'When authStateChanges() is listened '
        'Then emits null as the first event', () async {
      // Given: no user
      createService();
