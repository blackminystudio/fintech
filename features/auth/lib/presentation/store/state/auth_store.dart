...
import '../../../global/store/user_profile_store.dart';
...
class AuthStore extends StateNotifier<AuthState> {
  ...
  void _setUnauthenticated() {
    // state = state.copyWith(userProfile: const UserProfile());
    // _routeNotifier.setUnauthenticated();
  }

  Future<void> signInWithGoogle() async {
    if (isFetching) {
      state = state.copyWith(status: AuthStateStatus.loading, isLoading: true);
